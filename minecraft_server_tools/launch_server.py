...
if _coconut.typing.TYPE_CHECKING or _coconut_sys.version_info >= (3,):  #7 (line in Coconut source)
    from urllib.request import urlretrieve  # type: ignore  #7 (line in Coconut source)
...
if _coconut.typing.TYPE_CHECKING or _coconut_sys.version_info >= (3,):  #8 (line in Coconut source)
    from urllib.error import HTTPError  # type: ignore  #8 (line in Coconut source)
