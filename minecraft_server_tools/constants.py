...
def get_jvm_args(gc, vm, large_pages=USE_LARGE_PAGES):  #398 (line in Coconut source)
    ...
    if large_pages:  #454 (line in Coconut source)
        args += ["-XX:+UseLargePages", "-XX:LargePageSizeInBytes=2M", "-XX:+UseTransparentHugePages"]  # Obydux  # hilltty-flags, brucethemoose  # hilltty-flags, brucethemoose  #455 (line in Coconut source)

    if vm == "java":  #461 (line in Coconut source)
        args += ["-XX:+UseNUMA", "-XX:+UseVectorCmov", "-XX:MaxNodeLimit=240000", "-XX:NodeLimitFudgeFactor=8000"]  # brucethemoose: 8000  # hilltty-flags, brucethemoose: True; mukul1127: False; Obydux: True  # brucethemoose  # brucethemoose: 240000  #462 (line in Coconut source)
    elif vm == "graal":  #468 (line in Coconut source)
        args += ["-XX:+EagerJVMCI", "-Dgraal.TuneInlinerExploration=1", "-Dgraal.LoopRotation=true", "-Dgraal.CompilerConfiguration=enterprise"]  # Obydux  # brucethemoose  # Obydux  # brucethemoose: 1  #469 (line in Coconut source)
    ...
    if gc == "G1":  #479 (line in Coconut source)
        args += ["-XX:+UseG1GC", "-XX:AllocatePrefetchStyle=3", "-XX:SurvivorRatio=32", "-XX:InitiatingHeapOccupancyPercent=10", "-XX:MaxTenuringThreshold=1", "-XX:G1ReservePercent=20", "-XX:G1NewSizePercent=28", "-XX:G1HeapRegionSize=32M", "-XX:G1MixedGCCountTarget=3", "-XX:G1RSetUpdatingPauseTimePercent=0", "-XX:G1HeapWastePercent=20", "-XX:G1SATBBufferEnqueueingThresholdPercent=30", "-XX:G1ConcMarkStepDurationMillis=5", "-XX:GCTimeRatio=99"]  # brucethemoose: 23; atm: 30; aikar: 40; Obydux: 28; default: 5  # atm: 32; brucethemoose: 32; default: 8; Obydux: 32  # brucethemoose: 3; atm: 4; default: 8; Obydux: 3  # brucethemoose: 10; atm: 15; aikar: 20; default: 45; Obydux: 10  # brucethemoose, Obydux: 3; default: 1  # brucethemoose: 16M; atm: 8M; aikar: 16M; Obydux: 16M  # brucethemoose, Obydux: 5; default: 10  # brucethemoose: 20; atm: 20; aikar: 15; Obydux: 20  # brucethemoose: 0; atm: 5; default: 10; Obydux: 0  # brucethemoose, Obydux: 30; default: 60  # brucethemoose: 20; atm: 5; default: 5  # brucethemoose: 1; atm: 1; Obydux: 1; default: 15  # brucethemoose: 99; default: 12  #480 (line in Coconut source)
        ...
        args += ["-XX:+UseShenandoahGC", "-XX:AllocatePrefetchStyle=1", "-XX:ShenandoahGCMode=iu", "-XX:ShenandoahGuaranteedGCInterval=1000000"]  # brucethemoose: 1000000  # brucethemoose: 1; default: 1  # hilltty-flags  #503 (line in Coconut source)
    elif gc == "Z":  #509 (line in Coconut source)
        args += ["-XX:+UseZGC", "-XX:AllocatePrefetchStyle=1"]  # brucethemoose: 1; default: 1  #510 (line in Coconut source)
