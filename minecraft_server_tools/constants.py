...
def get_jvm_args(gc, vm, large_pages=USE_LARGE_PAGES):  #398 (line in Coconut source)
    ...
    if vm == "java":  #461 (line in Coconut source)
        args += ["-XX:+UseNUMA", "-XX:+UseVectorCmov", "-XX:MaxNodeLimit=240000", "-XX:NodeLimitFudgeFactor=8000"]  # brucethemoose  # brucethemoose: 8000  # brucethemoose: 240000  # hilltty-flags, brucethemoose: True; mukul1127: False; Obydux: True  #462 (line in Coconut source)
    elif vm == "graal":  #468 (line in Coconut source)
        args += ["-XX:+EagerJVMCI", "-Dgraal.TuneInlinerExploration=1", "-Dgraal.LoopRotation=true", "-Dgraal.CompilerConfiguration=enterprise", "-Dgraal.OptWriteMotion=true"]  # Obydux  # Obydux  # brucethemoose  # brucethemoose: 1  # Obydux; deprecated by java  #469 (line in Coconut source)
    ...
    if gc == "G1":  #479 (line in Coconut source)
        args += ["-XX:+UseG1GC", "-XX:AllocatePrefetchStyle=3", "-XX:SurvivorRatio=32", "-XX:InitiatingHeapOccupancyPercent=10", "-XX:MaxTenuringThreshold=1", "-XX:G1ReservePercent=20", "-XX:G1NewSizePercent=28", "-XX:G1HeapRegionSize=32M", "-XX:G1MixedGCCountTarget=3", "-XX:G1RSetUpdatingPauseTimePercent=0", "-XX:G1HeapWastePercent=20", "-XX:G1SATBBufferEnqueueingThresholdPercent=30", "-XX:G1ConcMarkStepDurationMillis=5.0", "-XX:GCTimeRatio=99", "-XX:G1ConcRSHotCardLimit=16", "-XX:G1ConcRefinementServiceIntervalMillis=150"]  # brucethemoose, Obydux: 5; default: 10  # brucethemoose: 20; atm: 20; aikar: 15; Obydux: 20  # brucethemoose, Obydux: 30; default: 60  # brucethemoose: 23; atm: 30; aikar: 40; Obydux: 28; default: 5  # brucethemoose, Obydux: 3; default: 1  # brucethemoose, Obydux: 150  # brucethemoose, Obydux: 16  # brucethemoose: 3; atm: 4; default: 8; Obydux: 3  # brucethemoose: 1; atm: 1; Obydux: 1; default: 15  # brucethemoose: 99; default: 12  # brucethemoose: 10; atm: 15; aikar: 20; default: 45; Obydux: 10  # atm: 32; brucethemoose: 32; default: 8; Obydux: 32  # brucethemoose: 16M; atm: 8M; aikar: 16M; Obydux: 16M  # brucethemoose: 20; atm: 5; default: 5  # brucethemoose: 0; atm: 5; default: 10; Obydux: 0  #480 (line in Coconut source)
        ...
        args += ["-XX:+UseZGC", "-XX:AllocatePrefetchStyle=1", "-XX:+ZGenerational"]  # brucethemoose: 1; default: 1  # brucethemoose (incompatible with -ZProactive; Java 21+; default in Java 23+); deprecated by java  #510 (line in Coconut source)
