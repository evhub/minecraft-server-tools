...
def get_jvm_args(gc, vm, large_pages=USE_LARGE_PAGES):  #362 (line in Coconut source)
    ...
    if vm == "java":  #409 (line in Coconut source)
        args += ["-XX:+UseNUMA", "-XX:+UseVectorCmov", "-XX:MaxNodeLimit=240000", "-XX:NodeLimitFudgeFactor=8000"]  # brucethemoose  # brucethemoose: 240000  # hilltty-flags, brucethemoose: True; mukul1127: False  # brucethemoose: 8000  #410 (line in Coconut source)
