...
if IS_MOD_SERVER:  #102 (line in Coconut source)
    CLIENT_RAM = "26G"  #103 (line in Coconut source)
# SERVER_RAM = "9G"
...
def get_jvm_args(gc, vm, large_pages=USE_LARGE_PAGES):  #362 (line in Coconut source)
    args = ["-server", "-Xss6M", "-XX:+UnlockExperimentalVMOptions", "-XX:+UnlockDiagnosticVMOptions", "-XX:+AlwaysPreTouch", "-XX:+DisableExplicitGC", "-XX:+OptimizeStringConcat", "-XX:+UseCompressedOops", "-XX:+ScavengeBeforeFullGC", "-XX:+ParallelRefProcEnabled", "-XX:+AlwaysActAsServerClassMachine", "-XX:-DontCompileHugeMethods", "-XX:+UseFastUnorderedTimeStamps", "-XX:+UseCriticalJavaThreadPriority", "-XX:+EnableDynamicAgentLoading", "-XX:MaxGCPauseMillis=37", "-XX:MaxMetaspaceExpansion=64M", "-XX:NmethodSweepActivity=1", "-XX:ReservedCodeCacheSize=400M", "-XX:NonNMethodCodeHeapSize=12M", "-XX:ProfiledCodeHeapSize=194M", "-XX:NonProfiledCodeHeapSize=194M", "-XX:ThreadPriorityPolicy=1", "-XX:ConcGCThreads={_coconut_format_0}".format(_coconut_format_0=(psutil.cpu_count(logical=False) * 3 // 4))]  # brucethemoose  # brucethemoose: 37; atm: 200; default: 200  # always  # brucethemoose: real cores - 2  # java warning  # default: True  # aikar-flags  # brucethemoose: 194M  # brucethemoose  # brucethemoose  # brucethemoose: 400M  # default: True  # brucethemoose: 1  # default: True  # brucethemoose  # brucethemoose: 1  # brucethemoose: 194M  # brucethemoose  # always  # brucethemoose: 12M  # always  # default: 5M  #363 (line in Coconut source)
    ...
    if vm == "java":  #409 (line in Coconut source)
        args += ["-XX:+UseNUMA", "-XX:+UseVectorCmov", "-XX:MaxNodeLimit=240000", "-XX:NodeLimitFudgeFactor=8000"]  # brucethemoose: 240000  # brucethemoose: 8000  # brucethemoose  # hilltty-flags, brucethemoose: True; mukul1127: False  #410 (line in Coconut source)
    elif vm == "graal":  #416 (line in Coconut source)
        args += ["-XX:+EagerJVMCI", "-Dgraal.TuneInlinerExploration=1"]  # brucethemoose  # brucethemoose: 1  #417 (line in Coconut source)
    ...
    if gc == "G1":  #424 (line in Coconut source)
        args += ["-XX:+UseG1GC", "-XX:AllocatePrefetchStyle=3", "-XX:SurvivorRatio=32", "-XX:InitiatingHeapOccupancyPercent=10", "-XX:MaxTenuringThreshold=1", "-XX:G1ReservePercent=20", "-XX:G1NewSizePercent=23", "-XX:G1HeapRegionSize=32M", "-XX:G1MixedGCCountTarget=3", "-XX:G1RSetUpdatingPauseTimePercent=0", "-XX:G1HeapWastePercent=20", "-XX:G1SATBBufferEnqueueingThresholdPercent=30", "-XX:G1ConcMarkStepDurationMillis=5.0", "-XX:GCTimeRatio=99", "-XX:G1ConcRSHotCardLimit=16", "-XX:G1ConcRefinementServiceIntervalMillis=150"]  # brucethemoose: 0; atm: 5; default: 10  # brucethemoose: 10; atm: 15; aikar: 20; default: 45  # brucethemoose: 30  # brucethemoose: 3; atm: 4; default: 8  # brucethemoose: 20; atm: 20; aikar: 15  # brucethemoose: 16M; atm: 8M; aikar: 16M  # brucethemoose: 5  # atm: 32; brucethemoose: 32; default: 8  # brucethemoose: 23; atm: 30; aikar: 40  # brucethemoose: 3  # brucethemoose: 20; atm: 5; default: 5  # brucethemoose: 1; atm: 1; default: 15  # brucethemoose: 150  # brucethemoose: 16  # brucethemoose: 99  #425 (line in Coconut source)
