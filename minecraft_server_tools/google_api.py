...
if _coconut.typing.TYPE_CHECKING or _coconut_sys.version_info >= (3,):  #4 (line in Coconut source)
    from urllib.parse import quote_plus  # type: ignore  #4 (line in Coconut source)
