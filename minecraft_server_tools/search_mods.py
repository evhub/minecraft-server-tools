...
if _coconut.typing.TYPE_CHECKING or _coconut_sys.version_info >= (3,):  #3 (line in Coconut source)
    import urllib.parse  # type: ignore  #3 (line in Coconut source)
else:  #3 (line in Coconut source)
    import urllib as _coconut_import_0  #3 (line in Coconut source)
    try:  #3 (line in Coconut source)
        urllib  # type: ignore  #3 (line in Coconut source)
    except:  #3 (line in Coconut source)
        urllib = _coconut.types.ModuleType(_coconut_py_str("urllib"))  #3 (line in Coconut source)
    else:  #3 (line in Coconut source)
        if not _coconut.isinstance(urllib, _coconut.types.ModuleType):  # type: ignore  #3 (line in Coconut source)
            urllib = _coconut.types.ModuleType(_coconut_py_str("urllib"))  #3 (line in Coconut source)
